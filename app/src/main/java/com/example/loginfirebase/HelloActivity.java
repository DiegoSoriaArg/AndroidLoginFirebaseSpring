...
import com.example.loginfirebase.interfaces.HelloInterface;
...
public class HelloActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.sing_out_buttom).setOnClickListener(new View.OnClickListener() {
            @Override
